#ifndef JULIASETINCLUDE
#define JULIASETINCLUDE

int _FractalIters;
float _FractalPower;
float4 _AdditiveConstant;
...
float FractalSDF(float3 p)
{
	...
	for (int i = 0; i < _FractalIters; i++)
	{
		...
		dr = pow(r, _FractalPower - 1.0f) * _FractalPower * dr;
